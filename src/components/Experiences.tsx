...
const Experiences = () => {
    const experiences = [
        {
            date: "JAN 24 - PRESENT",
            position: "Fullstack Developer · GT WebDev",
            description: "Creation of a collaborative whiteboard application using both front-end and back-end frameworks",
        ...
        },
        {
            ...
            description: "Training a classifier using a dataset aimed at organizing news headlines by topic. Implementing a method to automatically discern financially relevant news by utilizing stock price movements and news headlines",
            techstack: [],
        },
        {
            date: "JUL 22 - AUG 23",
